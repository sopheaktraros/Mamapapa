...
class RefundOrderDatatableResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $show = "";
        if(hasPermission('refund_order', 'read')){
            $show = "<a href='" . route('refund-orders.show', $this->id) . "'
                        class='btn btn-default btn-sm' style='border: 1px solid #227fc1;' 
        ...
        $date = date('d-m-Y / H:i A', strtotime($this->refund_order_date));
