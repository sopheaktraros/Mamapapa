...
class ReceivingProductDataTableResource extends JsonResource
{
    /**
    ...
    {
        $show = "";
        if(hasPermission('company_receiving', 'read')){
            $show = "<a href='" . route('receiving-products.show', $this->id) . "'
        ...
        $boxNumber = "";
        if(hasPermission('company_receiving', 'write')){
