...
class OwnOrderReceivingAirDataTableResource extends JsonResource
{
    /**
    ...
    {
        $show = "";
        if(hasPermission('own_order_receiving_air', 'read')){
            $show = "<a href='" . route('own-order-receiving-air.show', $this->id) . "'
